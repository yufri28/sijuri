            ...
            <div class="container-user">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#modalUbah<?= $no ?>"><i
                                                class="fa-regular fa-pen-to-square"></i></a>
                                        <a href="#" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#modalHapus<?= $no ?>"><i
                                                ...
                                                <div class="row g-3 modal-body">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="tnama"
                                                            value="<?= $user_item['nama'] ?>" pattern="[a-z0-9]{1,}$"
                                                            title="Menggunakan huruf kecil dan tidak menggunakan spasi"
                                                            class="form-control" id="inputNama" required
                                                            oninvalid="this.setCustomValidity('Menggunakan huruf kecil dan tidak menggunakan spasi')"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="tnamal"
                                                            ...
                                                            pattern="^[A-Z][a-zA-Z., ]*$"
                                                            title="Berawalan dengan huruf kapital" class="form-control"
                                                            id="inputNamaL" required
                                                    ...
                                                    <div class="col-md-6 modal-ubah">
                                                        ...
                                                        <button type="button" class="btn btn-secondary resetpwd"
                                                            id="resetPassword"><i
                                                                class="fa-solid fa-recycle"></i></button>
                                                        <input type="password" name="tpass"
                                                            class="form-control input-password" id="inputPass"
                                                            oninvalid="this.setCustomValidity('Kata sandi belum diisi')"
                                                            onchange="try{setCustomValidity('')}catch(e){}"
                                                            autocomplete="off" readonly
                                                            style="background-color: #f0f0f0;">
                                                        <span class="show-hide-user" id="showHideUser"><i
                                                                class="bx bx-show iconubah"></i></span>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="inputLevel" class="form-label">Level</label>
                                                        <select id="inputLevel" class="form-select" name="tlevel"
                                                            required>
                                                            <option value="<?= $user_item['level'] ?>" hidden>
                                                                <?= $user_item['level'] ?></option>
                                ...
                                <div class="modal fade modal-lg" id="modalHapus<?= $no ?>" data-bs-backdrop="static"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="staticBackdropLabel">Konfirmasi Hapus Data
                                                    User</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form class="row g-3" method="POST" action="dataUserAksi.php">
                                                ...
                                                <div class="row g-3 modal-body">
                                                    <h5 class="text-center"> Apakah anda yakin akan menghapus data ini?
                                                        <br>
                                                        <span class="text-danger"><?= $user_item['nama_lengkap'] ?> -
                                                            <?= $user_item['level'] ?></span>
                                                    </h5>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-primary" name="bhapus"><i
                                                            class="fa-regular fa-trash-can"></i> Ya, hapus
                                                        saja!</button>
                        ...
                        <!-- Awal Modal Tambah -->
                        <div class="modal fade modal-lg" id="modalTambah" data-bs-backdrop="static"
                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="row g-3" method="POST" action="dataUserAksi.php">
                                        <div class="row g-3 modal-body">
                                            <div class="col-md-6">
                                                <label for="inputNama" class="form-label">Nama Pengguna</label>
                                                <input type="text" name="tnama" pattern="[a-z0-9]{1,}$"
                                                    title="Menggunakan huruf kecil dan tidak menggunakan spasi"
                                                    class="form-control" id="inputNama" required
                                                    oninvalid="this.setCustomValidity('Menggunakan huruf kecil dan tidak menggunakan spasi')"
                                                    onchange="try{setCustomValidity('')}catch(e){}" autocomplete="off">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputNamaL" class="form-label">Nama Lengkap</label>
                                                <input type="text" name="tnamal" pattern="^[A-Z][a-zA-Z., ]*$"
                                                    title="Berawalan dengan huruf kapital" class="form-control"
                                                    id="inputNamaL" required
                                                    oninvalid="this.setCustomValidity('Berawalan dengan huruf kapital, diikuti huruf besar/kecil, koma, atau titik')"
                                                    onchange="try{setCustomValidity('')}catch(e){}" autocomplete="off">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="temail"
                                                    ...
                                                    id="inputEmail" required autocomplete="off">
                                            </div>
                                            <div class="col-md-6 modal-tambah">
                                                <label for="inputPass" class="form-label">Kata Sandi</label>
                                                <button type="button" class="btn btn-secondary resetpwd"
                                                    id="resetPassword"><i class="fa-solid fa-recycle"></i></button>
                                                <input type="password" name="tpass" class="form-control input-password"
                                                    id="inputPass" required
                                                    oninvalid="this.setCustomValidity('Kata sandi belum diisi')"
                                                    onchange="try{setCustomValidity('')}catch(e){}" autocomplete="off"
                                                    readonly style="background-color: #f0f0f0;">
                                                <span class="show-hide-user"><i
                                                        class="bx bx-show icontambah"></i></span>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputLevel" class="form-label">Level</label>
                                                <select id="inputLevel" class="form-select" name="tlevel" required
                                                    oninvalid="this.setCustomValidity('Level akses belum diisi')"
                                                    onchange="try{setCustomValidity('')}catch(e){}">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="reset" value="reset" class="btn btn-danger"
                                                data-bs-dismiss="modal"><i class="fa-solid fa-right-from-bracket"></i>
                                                Keluar</button>
                                        </div>
                                    </form>
                                </div>
    ...
    resetButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            successMessage.classList.add('text-success',
                'reset-success-message'); // Tambahkan kelas untuk warna teks hijau
