...
<body>
                        ...
                        <table id="example" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;" title="Nilai dari <?= $user['nama_lengkap'] ?>">Juri
                                        <?= $i++ ?></th>
                                    <?php endforeach; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php endforeach; ?>
                                    <td style="text-align: center;">
                                        <?= number_format($nilai_akhir[$alt['id_alternatif']], 2) ?></td>
                                    <td style="text-align: center;">
                                        <?= getKelompok(number_format($nilai_akhir[$alt['id_alternatif']], 2)) ?></td>
    ...
    $(document).ready(function() {
        ...
        $("#btnCetakData").click(function() {
            ...
            window.location.href = "hasilakhirCetak.php?tahun_periode=" + tahun + "&bulan_periode=" +
                bulan;
        });
    });
    </script>
    ...
    var nilai =
        <?php echo isset($nilai_akhir[$alternatif_item['id_alternatif']]) ? number_format($nilai_akhir[$alternatif_item['id_alternatif']], 2) : 0; ?>;
