                                            ...
                                            <?php foreach ($alternatif as $index => $alt) : ?>
                                                <tr>
                                                    ...
                                                    <?php foreach ($users as $user) : ?>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <?= isset($peringkat[$alt['id_alternatif']][$id_user]) ? $peringkat[$alt['id_alternatif']][$id_user] : '-' ?>
                                                        </td>
                                                    <?php endforeach; ?>
                                                    <td style="text-align: center;">
                                                        <?= number_format($nilai_akhir[$alt['id_alternatif']], 3) ?></td>
                                                    <td style="text-align: center;">
                                                        <?= getKelompok(number_format($nilai_akhir[$alt['id_alternatif']], 3)) ?>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <?= $akumulasi_predikat[$alt['id_alternatif']] ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
