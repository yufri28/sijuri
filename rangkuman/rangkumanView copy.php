                                            ...
                                            foreach ($alternatif as $alternatif_item) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalLihatKomentar<?= $alternatif_item['id_alternatif'] ?>">
                                                            <i class="fa fa-eye" aria-hidden="true"></i> Lihat
                                                        </button>
                                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalCetak<?= $alternatif_item['id_alternatif'] ?>">
            ...
            <div class="modal-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $sql_komentar = "SELECT komentar, id FROM penilaian WHERE id_alternatif = '{$alternatif_item['id_alternatif']}' AND id = '{$_SESSION['id']}'";
                        ...
                        if ($result_komentar && $result_komentar->num_rows > 0) {
                            while ($row_komentar = $result_komentar->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($row_komentar['id']) . "</td>";
                                echo "<td>" . htmlspecialchars($row_komentar['komentar']) . "</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='2' class='text-center'>Tidak ada komentar.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
<!-- Akhir Modal Lihat Komentar -->
                                                ...
                                                <!-- Awal Modal Cetak -->
                                                <div class="modal fade" id="modalCetak<?= $alternatif_item['id_alternatif'] ?>" tabindex="-1" aria-labelledby="modalCetakLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalCetakLabel">Cetak Data <?= htmlspecialchars($alternatif_item['nama_alternatif']) ?></h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
