                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        ?>
                                                                                                <div class="col-md-6">
                                                                                                    ...
                                                                                                    <input type="text" placeholder="Masukkan nilai antara 1-100" title="Jika nilainya desimal, maka silakan menggunakan titik (.)" class="form-control" name="nilai[<?= htmlspecialchars($id_kriteria) ?>][<?= htmlspecialchars($subkriteria_id) ?>]" min="0" max="100" value="<?= htmlspecialchars($nilai_subkriteria) ?>" pattern="^(100(\.0+)?|[1-9]?\d(\.\d+)?)$" oninvalid="this.setCustomValidity('Nilai belum diisi')" onchange="try{setCustomValidity('')}catch(e){}" autocomplete="off">
                                                                                                </div>
                                                                                        <?php
                                                                                            }
                                                                                        } else {
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        ?>
                                                                                                <div class="col-md-6">
                                                                                                    <label class="form-label"><?= htmlspecialchars($subkriteria_keterangan) ?></label>
                                                                                                    <input type="text" placeholder="Masukkan nilai antara 1-100" title="Jika nilainya desimal, maka silakan menggunakan titik (.)" class="form-control" name="nilai[<?= htmlspecialchars($id_kriteria) ?>][<?= htmlspecialchars($subkriteria_id) ?>]" min="0" max="100" pattern="^(100(\.0+)?|[1-9]?\d(\.\d+)?)$" oninvalid="this.setCustomValidity('Nilai belum diisi')" onchange="try{setCustomValidity('')}catch(e){}" autocomplete="off">
                                                                                                </div>
                                                                                        <?php
                                                                                            }
                                                                                        } else {
